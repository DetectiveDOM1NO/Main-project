...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.column('name', width=30, anchor=tk.CENTER)
        self.tree.column('tel', width=30, anchor=tk.CENTER)
        self.tree.column('email', width=30, anchor=tk.CENTER)
    ...
    def search_records(self, name):
        ...
        [self.tree.delete(i) for i in self.tree.get_children()]
        [self.destroy.insert('', 'end', values=row) for row in self.db.c.fetchall()]
...
class Search(tk.Toplevel):
    ...
    def init_search(self):
        ...
        self.entry_searh = ttk.Entry(self)
